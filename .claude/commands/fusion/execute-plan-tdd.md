...
5. recommend `/fusion:harvest-learnings`
6. after that, recommend `/trellis:check`
7. after that, recommend `/trellis:finish-work`
8. after human testing and commit, recommend `/trellis:record-session`
